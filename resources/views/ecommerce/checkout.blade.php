...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- ****** Header Area Start ****** -->
        <header class="header_area bg-img background-overlay-white" style="background-image: url({{ asset('assets/karl/img/core-img/1.jpg')}});">
                    ...
                    <div class="row h-100 align-items-center justify-content-end">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                <!-- Logo Area -->
                                <div class="top_logo">
                                    <a href="#"><img src="{{ asset('assets/karl/img/core-img/1.jpg')}}" alt=""></a>
                                </div>
                                <!-- Cart & Menu Area -->
                            ...
                            @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="number" name="customer_phone" require>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control mb-3" id="add1" name="customer_address" required>
                                        <p class="text-danger">{{ $errors->first('customer_address') }}</p>              
                                    </div>

                                    <div class="col-12 mb-3">
                                        <label for="state">Provinsi <span>*</span></label>
                                        <select class="form-control" name="province_id" id="province_id" require>
                                    ...
                                    <div class="col-12 mb-3">
                                        <label for="city">kabupaten / kota  <span>*</span></label>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                        <div class="order-details-confirmation">
                            ...
                            <ul class="order-details-form mb-4">
                                ...
                                <li><span>{{ \Str::limit($cart['product_name'], 10) }}</span> <span>Rp {{ number_format($cart['product_price']) }}</span></li>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="single_footer_area">
                            <div class="footer-logo">
                                <img src="{{ asset('assets/karl/img/core-img/1.jpg')}}" alt="">
                            </div>
